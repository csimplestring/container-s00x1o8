...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-s00x1o8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-s00x1o8.containers.anotherwebservice.com/
...
```
git clone git@github.com:csimplestring/container-s00x1o8.git
cd container-s00x1o8
```
...
```
docker attach container-s00x1o8
```
